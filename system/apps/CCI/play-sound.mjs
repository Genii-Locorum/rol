...
export default class ChaosiumCanvasInterfacePlaySound extends ChaosiumCanvasInterface {
  static get actionToggles () {
    ...
    buttons[ChaosiumCanvasInterface.actionToggle.On] = 'ROL.ChaosiumCanvasInterface.PlaySound.Action.Play'
    buttons[ChaosiumCanvasInterface.actionToggle.Off] = 'ROL.ChaosiumCanvasInterface.PlaySound.Action.Stop'
    return buttons
  }
  ...
  static defineSchema () {
    ...
    return {
      triggerButton: new fields.NumberField({
        ...
        label: 'ROL.ChaosiumCanvasInterface.PlaySound.Button.Title',
        hint: 'ROL.ChaosiumCanvasInterface.PlaySound.Button.Hint'
      }),
      action: new fields.NumberField({
        ...
        label: 'ROL.ChaosiumCanvasInterface.PlaySound.Action.Title',
        hint: 'ROL.ChaosiumCanvasInterface.PlaySound.Action.Hint',
        required: true
      }),
      playlistUuid: new fields.DocumentUUIDField({
        label: 'ROL.ChaosiumCanvasInterface.PlaySound.Playlist.Title',
        hint: 'ROL.ChaosiumCanvasInterface.PlaySound.Playlist.Hint',
        type: 'Playlist'
      }),
      soundUuid: new fields.DocumentUUIDField({
        label: 'ROL.ChaosiumCanvasInterface.PlaySound.Sound.Title',
        hint: 'ROL.ChaosiumCanvasInterface.PlaySound.Sound.Hint',
        type: 'PlaylistSound'
      })
    }
  }
