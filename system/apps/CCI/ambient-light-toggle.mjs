...
export default class ChaosiumCanvasInterfaceAmbientLightToggle extends ChaosiumCanvasInterface {
  static get actionToggles () {
    ...
    buttons[ChaosiumCanvasInterface.actionToggle.On] = 'ROL.ChaosiumCanvasInterface.AmbientLightToggle.Action.On'
    buttons[ChaosiumCanvasInterface.actionToggle.Off] = 'ROL.ChaosiumCanvasInterface.AmbientLightToggle.Action.Off'
    return buttons
  }
  ...
  static defineSchema () {
    ...
    return {
      triggerButton: new fields.NumberField({
        ...
        label: 'ROL.ChaosiumCanvasInterface.AmbientLightToggle.Button.Title',
        hint: 'ROL.ChaosiumCanvasInterface.AmbientLightToggle.Button.Hint'
      }),
      action: new fields.NumberField({
        ...
        label: 'ROL.ChaosiumCanvasInterface.AmbientLightToggle.Action.Title',
        hint: 'ROL.ChaosiumCanvasInterface.AmbientLightToggle.Action.Hint',
        required: true
      }),
      lightUuids: new fields.SetField(
        ...
        {
          label: 'ROL.ChaosiumCanvasInterface.AmbientLightToggle.Light.Title',
          hint: 'ROL.ChaosiumCanvasInterface.AmbientLightToggle.Light.Hint'
        }
      )
    }
  }
