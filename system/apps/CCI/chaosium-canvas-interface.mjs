export default class ChaosiumCanvasInterface extends foundry.data.regionBehaviors.RegionBehaviorType {
  static get actionToggles () {
    return {
      [ChaosiumCanvasInterface.actionToggle.On]: 'ROL.ChaosiumCanvasInterface.Actions.Show',
      [ChaosiumCanvasInterface.actionToggle.Off]: 'ROL.ChaosiumCanvasInterface.Actions.Hide',
      [ChaosiumCanvasInterface.actionToggle.Toggle]: 'ROL.ChaosiumCanvasInterface.Actions.Toggle'
    }
  }
  ...
  static get triggerButtons () {
    return {
      [ChaosiumCanvasInterface.triggerButton.Left]: 'ROL.ChaosiumCanvasInterface.Buttons.Left',
      [ChaosiumCanvasInterface.triggerButton.Right]: 'ROL.ChaosiumCanvasInterface.Buttons.Right'
    }
  }
