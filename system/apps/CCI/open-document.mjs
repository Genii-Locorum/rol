  ...
  static defineSchema() {
    ...
    return {
      triggerButton: new fields.NumberField({
        ...
        label: 'ROL.ChaosiumCanvasInterface.OpenDocument.Button.Title',
        hint: 'ROL.ChaosiumCanvasInterface.OpenDocument.Button.Hint'
      }),
      permission: new fields.StringField({
        ...
        initial: 'GM',
        label: 'ROL.ChaosiumCanvasInterface.OpenDocument.Permission.Title',
        hint: 'ROL.ChaosiumCanvasInterface.OpenDocument.Permission.Hint',
        required: true
      }),
      documentUuid: new fields.DocumentUUIDField({
        label: 'ROL.ChaosiumCanvasInterface.OpenDocument.Document.Title',
        hint: 'ROL.ChaosiumCanvasInterface.OpenDocument.Document.Hint'
      }),
